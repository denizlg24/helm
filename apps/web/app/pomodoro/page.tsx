...
import { PomodoroDashboard } from "@workspace/ui/pomodoro/pomodoro-dashboard"
  ...
  useEffect(() => {
    ...
    apiClient.user
      ...
      .then((response) => {
        ...
        setActiveWorkspaceId(response.authContext.workspaceId)
        setAccess(
          response.authContext.enabledModules.includes("pomodoro")
            ? { kind: "allowed" }
            : {
                kind: "denied",
      ...
      <main className="flex min-h-svh items-center justify-center bg-background px-6">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-2 text-muted-foreground text-sm">
            Enable the Pomodoro module for this workspace before opening this
            page.
          </p>
          <Button
            className="mt-6"
